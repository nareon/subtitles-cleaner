...
OUTPUT_TEXT   = Path("corpus/es3.llm_clean.txt")
OUTPUT_META   = Path("corpus/jsonl/es3_llm_filtered.jsonl")
CHECKPOINT    = Path("corpus/es3.llm_filter_checkpoint.json")
...
def build_user_content(batch):
    ...
    'Frases:\n0: ...\n1: ...'
    """
    lines = ["Evalúa las siguientes frases en español.",
